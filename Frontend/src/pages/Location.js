        ...
        <main className="side-content">
          ...
          <section className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-2">📍 Chittagong Medical Area</p>
              <p className="text-gray-600 mb-2">Road No: 12, Health Avenue</p>
              <p className="text-gray-600 mb-2">Chattogram, Bangladesh</p>
              <p className="text-gray-600 mb-4">☎ +880 1234 567 890</p>

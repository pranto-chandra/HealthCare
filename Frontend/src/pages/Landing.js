...
export default function Landing() {
  ...
  const [showDermatologyOptions, setShowDermatologyOptions] =
  ...
  return (
    <div className="dashboard">
      ...
      <div
        className={`main-content ${isSidebarOpen && shouldShowSidebar ? "sidebar-open" : ""}`}
      >
        {/* --- Hero Section --- */}
        ...
        <section className="chairman">
          <div className="chairman-content">
            ...
            <div>
              <img className="chaimanimg" src={chairmanImage} alt="Manager" />
            </div>
            <p>
            ...
            {[
              ...
              item.subSpecializations ? (
                ...
                <div
                  ...
                  key={i}
                  onClick={() =>
                    navigate(`/doctors/${encodeURIComponent(item.title)}`)
                  }
                  style={{ cursor: "pointer" }}
                >
                  <div className="dept-img">

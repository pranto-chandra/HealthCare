      ...
      try {
        ...
        allDoctors.forEach((doc) => {
          if (doc.specialties && Array.isArray(doc.specialties)) {
            doc.specialties.forEach(
              (s) => s?.name && specialitySet.add(s.name),
            );
          }
    ...
    if (specializationFilter) {
      filtered = filtered.filter((doc) => {
        ...
        return doc.specialties.some(
          (spec) => spec.name === specializationFilter,
        );
      });
    }
      ...
      <div className={`book-layout ${isSidebarOpen ? "" : "collapsed"}`}>
        ...
        <main className="book-content">
          ...
          <div className="ba-header">
            ...
            <p>
              Find and book an appointment with our healthcare professionals
            </p>
          </div>

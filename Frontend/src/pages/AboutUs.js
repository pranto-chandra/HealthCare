...
export default function AboutUs() {
  ...
  return (
    <div className="about-us-page">
      ...
      <div className={`about-us-layout ${isSidebarOpen ? "" : "collapsed"}`}>
          ...
          <section className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Our Healthcare Management System is designed to simplify patient
                care, empower doctors, and streamline administrative operations.
              </p>
              <p className="text-gray-600 leading-relaxed">
                With modern technology and a patient-first approach, we aim to
